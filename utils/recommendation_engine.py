"""
utils/recommendation_engine.py — Personalized restaurant recommendation scoring.

Combines user preference scores, lexical overlap, and quality signals into
a final recommendation score (1-10 scale).
