"""
utils/google_places.py — Google Places API enrichment for NYC restaurants.

Fetches ratings, reviews, price levels, editorial summaries, photos, and
Maps links for restaurants from the Google Places API.
