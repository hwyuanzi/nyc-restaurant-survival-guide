"""
utils/data.py — NYC DOHMH base data loader via OpenData API.

Fetches restaurant inspection data from the NYC Open Data SODA endpoint,
deduplicates by restaurant ID (camis), and normalizes column formats.
